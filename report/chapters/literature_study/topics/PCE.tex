...
Polynomial Dimensional Decomposition (PDD) is an alternative approach that addresses the poor scaling of PCE for high-dimensional problems. PDD decomposes the multivariate polynomial expansion into lower-dimensional components, reducing computational complexity while maintaining accuracy for systems with many uncertain parameters.
